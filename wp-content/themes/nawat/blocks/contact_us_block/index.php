...
<section id="<?= esc_attr($id) ?>" class="<?= esc_attr($className) ?>">
    <div class="container">
        <div class="info">
            <h1 class="main-title with-line">
                <?= esc_html($heading) ?>
            </h1>

            <div class="paragraph description size-22">
                <?= ($paragraph) ?>
            </div>
            ...
            <div class="links-wrapper">
                <?php if ($location): ?>
                    <div class="form-link paragraph size-22">
                ...
                <?php endif; ?>
                <?php if ($phone_number): ?>
                    <a href="tel:<?= esc_attr($phone_number) ?>" class="form-link paragraph size-22">
                ...
                <?php if ($email_link): ?>
                    ...
                    <a href="<?= esc_url($email_link['url']) ?>" target="<?= esc_attr($email_link['target']) ?>"
                       class="form-link paragraph size-22">
