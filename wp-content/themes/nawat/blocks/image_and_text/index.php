...
<section id="<?= esc_attr($id) ?>" class="<?= esc_attr($className) ?>">
    <div class="container">
        <div class="content">
            <div class="paragraph animation-fade-me-up"><?= ($paragraph) ?></div>
            <svg class="lines-shape animation-fade-me-up" width="43" height="218" viewBox="0 0 43 218" fill="none" xmlns="http://www.w3.org/2000/svg">
