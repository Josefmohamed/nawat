    ...
    <div class="content-wrapper">
        ...
        <?php if ($main_title): ?>
            ...
            <div class="links-wrapper">
                <?php if ($explore): ?>
                    <a class="explore" href="<?php echo esc_url($explore['url']); ?>" target="<?php echo esc_attr($explore['target'] ?: '_self'); ?>">
                ...
                <?php if ($join_community): ?>
                    <a class="join-community" href="<?php echo esc_url($join_community['url']); ?>" target="<?php echo esc_attr($join_community['target'] ?: '_self'); ?>">
